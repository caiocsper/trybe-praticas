// localStorage - salva os dados sem data de expiração. Os dados não serão removidos quando o browser for fechado, ou seja,
// eles ficarão disponíveis enquanto não forem explicitamente removidos.

console.log("LocalStorage Examples: ");
